...
const Services = () => {
  ...
  return (
    <>
      <section
        id="Services"
        className={`${ReadMore ? Styles.ServiceContainer : Styles.ServiceContainerActive
      ...
      >
        <h1 className="relative mb-10 text-2xl font-bold md:3xl lg:text-4xl">
          <span className="absolute rounded-full -top-3 -left-4 w-14 h-14 bg-third-color dark:bg-second-color "></span>
          <p className="relative z-10 font-TitrPlus">Our Services</p>
        </h1>
